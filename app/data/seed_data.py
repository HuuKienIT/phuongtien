...
from ..models import (
    ...
    VehicleTracking, VehicleMaintenance, VehicleBatteryLog, VehicleModel
)
...
vehicle_models_data = [
    {"model_name": "VinFast Klara S", "manufacture_year": 2023, "origin": "Việt Nam", "vehicle_type": "Xe máy điện", "engine_power": 1200, "battery_type": "Lithium-ion", "battery_capacity": 22.8, "range_per_charge": 120, "image_url": "https://example.com/klara_s.jpg"},
    {"model_name": "Yadea G5", "manufacture_year": 2023, "origin": "Trung Quốc", "vehicle_type": "Xe máy điện", "engine_power": 1500, "battery_type": "Lithium-ion", "battery_capacity": 23, "range_per_charge": 110, "image_url": "https://example.com/yadea_g5.jpg"},
    {"model_name": "Honda PCX Electric", "manufacture_year": 2023, "origin": "Nhật Bản", "vehicle_type": "Xe máy điện", "engine_power": 2000, "battery_type": "Lithium-ion", "battery_capacity": 25, "range_per_charge": 100, "image_url": "https://example.com/pcx_electric.jpg"},
    {"model_name": "Gogoro 2 Series", "manufacture_year": 2023, "origin": "Đài Loan", "vehicle_type": "Xe máy điện", "engine_power": 1700, "battery_type": "Lithium-ion", "battery_capacity": 24, "range_per_charge": 110, "image_url": "https://example.com/gogoro_2.jpg"},
    {"model_name": "Pega eSH", "manufacture_year": 2023, "origin": "Việt Nam", "vehicle_type": "Xe máy điện", "engine_power": 1200, "battery_type": "Lithium-ion", "battery_capacity": 22, "range_per_charge": 115, "image_url": "https://example.com/pega_esh.jpg"},
]
...
async def seed_data(db: AsyncSession):
    ...
    if not existing_stations:
        # Thêm các mẫu xe vào bảng VehicleModel
        model_instances = []
        for model_data in vehicle_models_data:
        ...
        for name, address in stations_data:
            ...
            if latitude and longitude:
                ...
                for i in range(5):  # Seed 5 xe cho mỗi trạm
                    vehicle_model = random.choice(model_instances)
                    ...
                    vehicle = Vehicle(
                        ...
                        current_battery_capacity=random.uniform(20, 100),
                        current_station_id=station.id,
                        total_km_driven=random.randint(500, 5000),
                    ...
                    insurance = VehicleInsurance(
                        ...
                        provider_name="Bảo hiểm PVI",
                        policy_number=f"INS-{random.randint(10000, 99999)}",
                        start_date=datetime.now(timezone.utc) - timedelta(days=180),
                        expiry_date=datetime.now(timezone.utc) + timedelta(days=180),
                        coverage_details="Bảo hiểm toàn diện"
                    )
                    db.add(insurance)

                    tracking = VehicleTracking(
                        vehicle_id=vehicle.id,
                        current_latitude=latitude + random.uniform(-0.001, 0.001),
                    ...
                    maintenance = VehicleMaintenance(
                        ...
                        maintenance_details="Kiểm tra bình điện và hệ thống vận hành"
                    )
                    db.add(maintenance)
